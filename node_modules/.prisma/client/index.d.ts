...
export namespace Prisma {
  ...
  */
  ...
  export type TweetGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'author' ? UserGetPayload<S['select'][P]> :  P extends keyof Tweet ? Tweet[P] : never
  } 
    : Tweet
  : Tweet
  ...
  export interface TweetDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `tweetNo`
     * const tweetWithTweetNoOnly = await prisma.tweet.findMany({ select: { tweetNo: true } })
     * 
    **/
  ...
  export type UserWhereInput = {
    ...
    undatedAt?: DateTimeFilter | Date | string
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    undatedAt?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type TweetScalarWhereWithAggregatesInput = {
    ...
    tweetNo?: IntWithAggregatesFilter | number
  ...
  export type UserUpdateInput = {
    ...
    undatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type TweetUncheckedUpdateInput = {
    tweetNo?: IntFieldUpdateOperationsInput | number
